	...
	return (
		<div>
				...
				<div className="mx-auto mt-12 grid max-w-4xl gap-8 text-left md:grid-cols-2">
					<Card>
						...
						<p className="mb-4 text-sm leading-relaxed text-base-content/65">
							...
							creators. Ghost excels at long-form content, email newsletters, paid memberships, and
			...
			<Section tint>
				...
				<Lede>
					Ghost is laser-focused on written publishing and newsletters. Anthers covers a wider range
					of creative media—ideal for indie creators who work across multiple formats.
				</Lede>
			...
			<Section tint>
				...
				<Lede>
					Ghost and Anthers share a core belief: creators should own their work, their audience, and
					their data. They just approach it differently.
				</Lede>
				<div className="mx-auto mt-14 grid max-w-4xl gap-8 text-left sm:grid-cols-3">
					<div>
						...
						<p className="text-sm leading-relaxed text-base-content/70">
							Ghost publishes its entire codebase under the MIT license. You can self-host, modify,
							and run your own instance. Your data lives on your server.
						</p>
					</div>
					<div>
						<div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary">
