...
/**
 * Seed the **media fixture**: a creator, a video Work, and an album of three audio tracks,
 * all carrying media produced by the real transcode jobs.
 *
...
/** Create the Work row if absent, and return its id. Never rewrites an existing one's gates. */
