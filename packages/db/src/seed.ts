	...
	[`${SEED_PREFIX}novapixel`]: [
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["rpg", "farming-sim", "pixel-art", "roguelike", "indie"]),
			pricingType: "paid",
			price: "12.99",
		},
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["platformer", "speedrun", "pixel-art", "level-editor"]),
			pricingType: "free",
		},
		{
			...
			mediaType: "audio",
			tags: JSON.stringify(["chiptune", "lo-fi", "ost", "game-music"]),
			pricingType: "pwyw",
			minPrice: "0.00",
			suggestedPrice: "3.00",
		},
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["puzzle", "relaxing", "pixel-art", "short"]),
			pricingType: "free",
		},
	],
	[`${SEED_PREFIX}sagemoreno`]: [
		{
			...
			mediaType: "audio",
			tags: JSON.stringify(["podcast", "technology", "culture", "interviews"]),
			pricingType: "free",
		},
	],
	[`${SEED_PREFIX}fluxbeats`]: [
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["music-tool", "synthesizer", "web-audio", "open-source"]),
			pricingType: "free",
		},
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["visuals", "webgl", "live-performance", "creative-tools"]),
			pricingType: "paid",
			price: "4.99",
		},
	],
	[`${SEED_PREFIX}marisol`]: [
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["visual-novel", "narrative", "sci-fi", "point-and-click"]),
			pricingType: "free",
		},
		{
			...
			mediaType: "text",
			tags: JSON.stringify(["zine", "illustration", "art", "sketchbook"]),
			pricingType: "pwyw",
			minPrice: "0.00",
			suggestedPrice: "5.00",
		},
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["puzzle", "relaxing", "illustration", "casual"]),
			pricingType: "paid",
			price: "3.99",
		},
	],
	[`${SEED_PREFIX}hexbound`]: [
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["horror", "narrative", "psychological", "replayable"]),
			pricingType: "paid",
			price: "7.99",
		},
		{
			...
			mediaType: "game",
			tags: JSON.stringify(["horror", "puzzle", "jam-game", "atmospheric"]),
			pricingType: "free",
		},
		{
			...
			mediaType: "video",
			tags: JSON.stringify(["devlog", "game-design", "behind-the-scenes"]),
			pricingType: "free",
		},
	],
};
