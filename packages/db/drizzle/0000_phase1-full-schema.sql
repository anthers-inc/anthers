...
CREATE TABLE "crf_subsidies" (
	...
	"estimated_hosting_cost" numeric(8, 2) NOT NULL,
	"creator_earnings" numeric(8, 2) NOT NULL,
	"subsidy_amount" numeric(8, 2) NOT NULL,
...
CREATE TABLE "atproto_sessions" (
	...
	"token_endpoint" varchar(500) DEFAULT '',
	"dpop_nonce" varchar(255) DEFAULT '',
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "pool_distributions" (
	...
	"creator_id" integer NOT NULL,
	"billing_cycle" date NOT NULL,
	"pool_amount" numeric(8, 2) DEFAULT '0.00' NOT NULL,
	"boost_amount" numeric(8, 2) DEFAULT '0.00' NOT NULL,
...
CREATE TABLE "platform_connections" (
	...
	"platform_user_id" varchar(255) DEFAULT '',
	"platform_username" varchar(255) DEFAULT '',
	"is_active" boolean DEFAULT true,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
...
CREATE TABLE "projects" (
	...
	"media_type" varchar(10) DEFAULT 'game' NOT NULL,
...
CREATE TABLE "transcoding_jobs" (
	...
	"error_message" text DEFAULT '',
	"hls_manifest_url" varchar(500) DEFAULT '',
	"output_file_url" varchar(500) DEFAULT '',
	"waveform_data" jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
