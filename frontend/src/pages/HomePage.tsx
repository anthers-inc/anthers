    ...
    <div>
        ...
        <div className="hero-content text-center py-20">
          <div className="max-w-3xl">
            ...
            <p className="py-6 text-xl text-base-content/70 leading-relaxed max-w-2xl mx-auto">
              A home for creators. Publish games, videos, music, and writing.
              Build your audience. Keep 100% of your earnings.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-center text-base-content/60 max-w-2xl mx-auto mb-12">
            Bluebell is designed for zero-friction discovery. You don't need
            an account to browse, download free content, or play web games.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-semibold">Play instantly</h4>
                <p className="text-sm text-base-content/60">
                  HTML5 games run in the browser with one click. No downloads,
            ...
            <div className="flex gap-3">
              <span className="text-2xl">📥</span>
              <div>
                <h4 className="font-semibold">Download freely</h4>
                <p className="text-sm text-base-content/60">
                  Free content is genuinely free — no login wall, no email
                  gate, no "subscribe to download" tricks.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-2xl">🔔</span>
              <div>
                <h4 className="font-semibold">Follow creators</h4>
                <p className="text-sm text-base-content/60">
                  Create a free account to follow your favorite creators and
                  see all their updates in one feed.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-2xl">🏆</span>
              <div>
                <h4 className="font-semibold">Join game jams</h4>
                <p className="text-sm text-base-content/60">
                  Play entries, vote on your favorites, and discover new
                  creators through community events.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gradient-to-b from-base-200 to-base-100 py-20">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          ...
          <p className="text-base-content/60 mb-8 leading-relaxed">
            Bluebell is free to use for creators and audiences. No platform
            cut, no hidden fees. Just publish your work and keep what you earn.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              to={isAuthenticated ? "/dashboard" : "/register"}
